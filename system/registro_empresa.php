...
session_start();
	...
	if (isset($_POST)) {
		...
		if ($nombre_empresa == "" or	$rif_empresa == "" or	$direccion_fiscal == "" or $cantidad_trabajadores == "" or $nombre_contacto == "" or $apellido_contacto == "" or $telefono_contacto == "" or $correo_contacto == "") {
			...
			$con = new conexion();
			$con->registrar_empresa($id_empresa, $nombre_empresa, $rif_empresa, $direccion_fiscal, $cantidad_trabajadores,$estatus);

			$con->registrar_contacto_principal($id_contacto, $nombre_contacto, $apellido_contacto, $telefono_contacto, $correo_contacto, $rif_empresa);
